        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('therapist.schedule')" :active="request()->routeIs('therapist.schedule')">
                        {{ __('Schedule') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('therapist.viewSession')" :active="request()->routeIs('therapist.viewSession')">
                        {{ __('View Session') }}
                    </x-nav-link>
